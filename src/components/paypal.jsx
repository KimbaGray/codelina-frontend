...
class PayPal extends Component {
  ...
  timeStampToBritishDateTime(time) {
    ...
    return (
      myTime.toTimeString().substr(0, 5) +
      amPm +
      " " +
      this.timeStampToBritishDate(time)
    );
  }
      ...
      <div>
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
          ...
          <input
            type="hidden"
            name="item_name"
            value={`Reiki session, ${this.calculateDuration(
              this.props.startTime,
              this.props.endTime
            )} minutes, Start time: ${this.timeStampToBritishDateTime(
              this.props.startTime
            )} `}
          />
          <input
          ...
          <input
            ...
            name="return"
            id="return"
            value="https://brazilianglow.co.uk/dashboard"
          />
          <input
            type="hidden"
            name="notify_url"
