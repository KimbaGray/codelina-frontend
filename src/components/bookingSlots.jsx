...
const api = "https://brazilianglow.co.uk/api/availability";
...
class BookingSlots extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <br />
        <p className="money">£60/hour</p>
        <br />
        <p className="money">
          Please select your session below and pay the 20% deposit via the
          PayPal button
        </p>
        <br />
        ...
        <div>
          ...
          <p>
            ...
            <a
              href="https://drive.google.com/file/d/17Y4fbJYh5tPjetwgUsMl-VtwTmooINO1/view?usp=sharing"
              target="_blank"
              className="tAndCs"
            >
